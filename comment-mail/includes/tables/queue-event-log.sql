CREATE TABLE IF NOT EXISTS `%%prefix%%queue_event_log` (
  ...
  `comment_parent_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT 'Comment parent ID from the `wp_comments` table, if applicable. The comment may or may not still exist.',
