...
namespace comment_mail // Root namespace.
{
	...
	if(!class_exists('\\'.__NAMESPACE__.'\\menu_pages'))
	{
		 ...
		 * @since 14xxxx First documented version.
		 */
		class menu_pages extends abstract_base
		{
			/**
			 * Class constructor.
			 *
			...
			public function options()
			{
				...
				echo '      <img src="'.$this->plugin->utils_url->to('/client-s/images/options.png').'" alt="'.esc_attr(__('Plugin Options', $this->plugin->text_domain)).'" style="width:400px;" />'."\n";
