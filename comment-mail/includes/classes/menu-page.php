	...
	if(!class_exists('\\'.__NAMESPACE__.'\\menu_page'))
	{
		...
		class menu_page extends abs_base
		{
			...
			protected function import_export_()
			{
				...
				echo $this->panel(__('CSV Import and/or Mass Update', $this->plugin->text_domain), $_panel_body, array('icon' => '<i class="fa fa-upload"></i>', 'pro_only' => TRUE, 'pro_preview_force' => TRUE));
				...
				echo $this->panel(__('CSV Export (File Download)', $this->plugin->text_domain), $_panel_body, array('icon' => '<i class="fa fa-download"></i>', 'pro_only' => TRUE, 'pro_preview_force' => TRUE));
				...
				echo $this->panel(__('Import Config. Options', $this->plugin->text_domain), $_panel_body, array('icon' => '<i class="fa fa-upload"></i>', 'pro_only' => TRUE, 'pro_preview_force' => TRUE));
				...
				echo $this->panel(__('Export Config. Options', $this->plugin->text_domain), $_panel_body, array('icon' => '<i class="fa fa-download"></i>', 'pro_only' => TRUE, 'pro_preview_force' => TRUE));
