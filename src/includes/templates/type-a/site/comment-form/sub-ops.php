...
<div class="comment-sub-ops" data-auto="position">
    ...
    <label for="<?php echo esc_attr($sub_type_id); ?>" class="cso-sub-type">
        ...
        <?php echo __('Receive Email Notifications?', 'comment-mail'); ?>
    </label>
  ...
  <div class="cso-sub-list">
    ...
    <div class="cso-links">
        <span class="cso-link-new"><?php echo sprintf(__('Or, you can <a href="%1$s">subscribe without commenting</a>.', 'comment-mail'), esc_attr($sub_new_url)); ?></span>
        <?php if ($current->sub_email) : // TIP: this is optional. If you exclude this, subscribers can still view their summary via emails they receive. ?>
            <span class="cso-link-summary">~ <a href="<?php echo esc_attr($sub_summary_url); ?>"><?php echo __('manage my subscriptions', 'comment-mail'); ?></a></span>
        <?php endif; ?>
    </div>
